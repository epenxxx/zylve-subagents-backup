...
OUTPUT_DIR = "/root/assets/stock_karaoke_koplo/published/salah_apa_adella"
...
PROMPT_TEXT = (
    ...
    "Pertahankan foto asli Difarina Indra dan Fendik Adella dengan sangat tajam dan pencahayaan panggung orkes dangdut glamor. "
    "Tambahkan teks besar 3D warna emas menyala: 'KARAOKE' dan 'SALAH APA'. "
    "Tambahkan badge merah tebal: 'by ZYLVEmedia' dan 'LIRIK BERJALAN'. "
    "Tambahkan mikrofon panggung metalik berkilau dan gelombang audio wave neon di latar panggung ungu keemasan. "
    "Fotorealistis 4K standar resmi YouTube Music OM ADELLA, DILARANG kartun, DILARANG animasi lilin slop."
)
...
async def run_flow():
    ...
    async with async_playwright() as p:
        ...
        await page.screenshot(path="/root/screenshots/flow_salah_apa_prompt.png")
        ...
        # Konversi ke JPG kualitas 95 untuk YouTube API
